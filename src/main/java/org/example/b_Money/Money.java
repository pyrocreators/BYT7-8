...
public class Money implements Comparable {
    ...
    public String toString() {
        double amountBeDisplayed = amount / 100.0;
        return String.format("%.2f %s", amountBeDisplayed, currency.getName());
    }
    ...
    public int compareTo(Object other) {
        ...
        int otherUniversalValue = ((Money) other).universalValue();
        return Integer.compare(thisUniversalValue, otherUniversalValue);
    }
}